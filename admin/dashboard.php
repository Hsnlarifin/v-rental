...
<head>
	...
	<title>V-Rental | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">No. of Users</div>
												</div>
											</div>
									...
									<!-- <div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
<?php 
$sql4 ="SELECT cust_ID from customer ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">No. of Customer</div>
												</div>
											</div>
									...
									<!-- <div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql6 ="SELECT veh_ID from vehicle_status where status = 'Unavailable' ";
...
?>
											...
											<a href="testimonials.php" class="block-anchor panel-footer text-center">More &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
$sql3 ="SELECT sup_ID from supplier ";
$query3= $dbh -> prepare($sql3);
$query3->execute();
$results3=$query3->fetchAll(PDO::FETCH_OBJ);
$brands=$query3->rowCount();
?>												
													<div class="stat-panel-number h1 "><?php echo htmlentities($brands);?></div>
													<div class="stat-panel-title text-uppercase">Vehicle suppliers</div>
												</div>
											</div>
											<a href="manage-brands.php" class="block-anchor panel-footer text-center">More &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
<?php 
$sql4 ="SELECT staff_ID from staff ";
$query4 = $dbh -> prepare($sql4);
$query4->execute();
$results4=$query4->fetchAll(PDO::FETCH_OBJ);
$subscribers=$query4->rowCount();
