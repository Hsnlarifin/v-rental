...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2023 at 05:26 AM
...
(8, 'Audi', '2023-01-18 03:39:19', NULL),
(9, 'Volvo', '2023-01-18 03:57:16', NULL);
...
(15, 55, 'CASH', '2023-01-18 04:50:43', 'PAID', 1800),
(16, 56, 'ONLINE', '2023-01-18 06:23:59', 'PAID', 3000);
...
(55, 4933, 7, 1, NULL, '2023-03-02', '2023-03-11', NULL, 'CONFIRMED', 9),
(56, 4079, 7, 5, NULL, '2023-01-18', '2023-01-21', NULL, 'CONFIRMED', 3);
...
CREATE TABLE `vehicle` (
  ...
  `veh_plateNo` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
...
INSERT INTO `vehicle` (`veh_ID`, `veh_Model`, `price_per_Day`, `fuel_Type`, `veh_Colour`, `seating_Capacity`, `veh_Transmission`, `veh_plateNo`, `veh_Image_1`, `register_Date`, `update_Date`, `brand_ID`) VALUES
...
(6, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', NULL, '2023-01-18 03:39:19', NULL, 8),
(8, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', NULL, '2023-01-18 03:43:16', NULL, 8),
(10, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', NULL, '2023-01-18 03:43:59', NULL, 8),
(12, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', 'a7.jpg', '2023-01-18 03:46:26', '2023-01-18 04:19:20', 8),
(13, 'S90', NULL, 'Ron 95', 'blue', '5', 'AT', 'S90', NULL, '2023-01-18 03:57:16', NULL, 9),
(15, 'S90', NULL, 'Ron 95', 'blue', '5', 'AT', 'S90', NULL, '2023-01-18 04:03:26', NULL, 9),
(17, 'S90', NULL, 'Ron 97', 'white', '5', 'automatic', 'S91', '', '2023-01-18 04:05:28', '2023-01-18 06:20:48', 9),
(18, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', NULL, '2023-01-18 04:06:07', NULL, 9),
(20, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', NULL, '2023-01-18 04:07:27', NULL, 9),
(21, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', 'volvo s90.jpg', '2023-01-18 04:08:59', '2023-01-18 04:08:59', 9),
(22, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', 'Audi-A7-Sportback-10 (1).jpg', '2023-01-18 04:09:22', '2023-01-18 04:09:22', 8),
(23, 'A7', NULL, 'Ron 97', 'white', '5', 'automatic', 'Audi 1', 'benz 1.jpg', '2023-01-18 04:19:58', '2023-01-18 04:19:58', 8);
...
INSERT INTO `vehicle_record` (`red_id`, `veh_ID`, `sup_id`, `policy_no`, `ins_plan`, `condition_type`, `add_date`, `update_date`, `car_loan_status`, `Progress`) VALUES
(1, 12, 1001, '1234 5678 9012', 'Third Party Fire & Theft', 'New Car', '2023-01-18', NULL, 'Lead', 'Pending'),
(2, 17, 1001, '1234 5678 9012', 'Third Party', 'Used Car', '2023-01-18', NULL, 'Full Loan', 'Pending'),
(3, 21, 1001, '1234 5678 9012', 'Third Party Fire & Theft', 'Used Car', '2023-01-18', NULL, 'Full Loan', 'Pending'),
(4, 22, 1001, '1234 5678 9012', 'Third Party', 'Used Car', '2023-01-18', NULL, 'Full Loan', 'Pending'),
(5, 23, 1001, '1234 5678 9012', 'Third Party Fire & Theft', 'Used Car', '2023-01-18', NULL, 'Full Loan', 'Pending');
...
--
ALTER TABLE `reservation`
  MODIFY `resv_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `vehicle`
  MODIFY `veh_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `vehicle_record`
--
ALTER TABLE `vehicle_record`
  MODIFY `red_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
