...
(1, 16, 'aimnfarihin_', '4imaN', 'No 45, Jln Jasin, Taman Belia', 75450, 'Ayer Keroh', 'Melaka', '2023-01-15 17:43:05', NULL),
...
(4, 19, 'haziiq', 'haziq99', 'No 33, Jln Manggis, Taman Melati', 40000, 'Shah Alam', 'Selangor', '2023-01-15 17:43:05', NULL),
(5, 20, 'abdulrazak', 'Razakk3', 'Lot 14, Jln Melawati, Taman Kasih', 40000, 'Shah Alam', 'Selangor', '2023-01-15 17:43:05', NULL),
...
(1, 1, 1, 'amrl_', 'Amiru1', 'Director', 19198.4),
...
(16, 'Aiman', 'Farihin', 'Male', 23, 'aimanfarihin@gmail.com', '0128846432'),
...
(1, 1, 1, 'ALL', 'ALL', 'Second Hand', '0000-00-00', NULL, 'FULLY PAID', 'Pending');
...
--
ALTER TABLE `reservation`
  MODIFY `resv_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `vehicle_record`
  MODIFY `red_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
